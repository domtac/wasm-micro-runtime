...
class TEST_SUITE_NAME : public testing::Test
{
  protected:
    virtual void SetUp()
    {
         ...
         * fast-jit untestable on this host (see deferred-work.md, Story
         * 2.4 entry, for full detail):
         *
        ...
        GTEST_SKIP() << "fast-jit is not exercisable on this host: this "
                        ...
                        "platforms independent of that -- see "
                        "deferred-work.md, Story 2.4 entry";
#endif
 ...
 *
 * Ported from Story 2.2's linear-memory-wasm/linear_memory_wasm_test.cc,
 * parameterized on page_size_log2 to support Story 2.4's two-instance,
 ...
 * used throughout Epic 1/2's loader- and runtime-level tests.
 */
std::vector<uint8_t>
